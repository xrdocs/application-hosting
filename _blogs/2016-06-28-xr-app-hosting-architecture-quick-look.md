...
*  In green, we see the container called the XR Control plane LXC (or XR LXC). This runs a Windriver Linux 7 (WRL7) environment as well and contains the XR control plane and the XR linux environment:  
  ...
  <img href="https://xrdocs.github.io/xrdocs-images/assets/images/xr-control-plane-lxc.png" src="https://xrdocs.github.io/xrdocs-images/assets/images/xr-control-plane-lxc.png" width="250" height="250" />{: .align-center}
