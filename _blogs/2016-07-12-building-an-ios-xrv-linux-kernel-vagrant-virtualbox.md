...
Our primary focus will be on consistent tooling and workflows such as Vagrant boxes, open source sample applications and build tools to give complete flexibility to an end user.**
{: .notice--info}
