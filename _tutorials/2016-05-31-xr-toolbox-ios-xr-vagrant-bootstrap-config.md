...
## Pre-requisite
* Meet the pre-requisites specified in the [IOS-XR Vagrant Quick Start guide]({{ https://xrdocs.github.io/application-hosting/tutorials/iosxr-vagrant-quickstart#pre-requisites)
