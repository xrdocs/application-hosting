...
- All packets to the application are policed by the XR control protection, LPTS. Read this blog to learn more about XR's LPTS [Introduction to NCS 55XX and NCS 5xx LPTS](https://xrdocs.io/ncs5500/tutorials/introduction-to-ncs55xx-and-ncs5xx-lpts/)
