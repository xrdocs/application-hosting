...
excerpt: "IOSXR-Ansible tutorial"
published: true
title: "XR-Ansible.md"
---
# Introduction
In this tutorial we are going to cover XRv64 configuration with Ansible. We will setup and try simplest configuration with Unix machine connected to XRv64.
...
We will not care about [YDK](https://github.com/CiscoDevNet/ydk-py-samples) for now, it's topic for another tutorial. 
...
ansible-playbook samples/iosxr_get_facts.yml --ask-pass
ansible-playbook iosxr_cli.yml -e 'cmd="show interface brief"' --ask-pass
```

Samples folder contain various playbooks, files started with "show" using iosxr_cli playbook and passing cmd for XR as parameter. 
