...
For a more detailed walkthrough of Vagrant with IOS-XR, along with examples of topologies and configuration, take a look at the ["Setting up the XR toolbox" series]({{ base_path }}/tags/#xr-toolbox)
{: .notice--info}
