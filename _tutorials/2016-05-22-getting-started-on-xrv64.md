...
To learn more about how to use (IOS-XR + Vagrant) to test native and container applications on IOS-XR, or to use configuration management tools like Chef/Puppet/Ansible/Shell as vagrant provisioners, take a look at the rest of the ["XR toolbox" series]({{ base_path }}/tags/#xr-toolbox)
